...
public class MainActivity extends SlidingFragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int width = getWindow().getWindowManager().getDefaultDisplay().getWidth();  // 获取屏幕宽度

        // 因为我们设置200的时候屏幕的宽度为320的像素，所以我们为了适配屏幕，将要将200/320 * width
        slidingMenu.setBehindOffset((width * 200) / 320);       // 设置屏幕预留面积
